...
import { Button, IconX, Space, Card, Auth, Typography } from '@wesbitty/ui'
...
const wesbitty = createClient(
  'https://wesbitty.us.auth0.com',
  'ACXF6HI7s6Wh_dxXbrx2ALuKoy21RFLMQpPwWjgtEr2HjTwfAUOq1RhlnWu2nqIC'
)
