...
import { Button, IconGitHub } from '@wesbitty/ui'
import Layout from '../components/Layouts/Default'
import Link from 'next/link'

export const meta = {
  type: 'lp',
  title: 'Security at Wesbitty',
  description:
    'Wesbitty is trusted by thousands of developers for building and deploying secure applications.',
}
...
![Wesbitty security](/images/security/security-hero.png)
...
Wesbitty is SOC2 Type 1 compliant. Enterprise customers can request a copy of our SOC2 [here](https://supabase.com/legal/soc2).
