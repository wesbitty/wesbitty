...
[Slack](https://wesbitty.com/docs/guides/auth/auth-slack),
[Spotify](https://wesbitty.com/docs/guides/auth/auth-spotify), and
[MessageBird](https://wesbitty.com/docs/guides/auth/auth-messagebird) phone logins.
...
[Docs](https://wesbitty.com/docs/reference/javascript/initializing#api-schemas).
...
Learn about PostgreSQL Functions. [Docs](https://wesbitty.com/docs/guides/database/functions).
...
Learn about all the exciting features of Auth within Supabase. [Docs](https://wesbitty.com/docs/guides/auth/intro).
...
Learn more about the power of PostgREST for RESTful APIs. [Docs](https://wesbitty.com/docs/guides/api#restful-api).
...
- Redwood Quickstart: [https://wesbitty.com/docs/guides/with-redwoodjs](https://wesbitty.com/docs/guides/with-redwoodjs)
- Expanded Self-hosting: [https://wesbitty.com/docs/guides/hosting/overview](https://wesbitty.com/docs/guides/hosting/overview)
- Expanded Auth Reference docs with [serverside functions](https://wesbitty.com/docs/reference/javascript/auth-api-deleteuser).
- "Before you launch" checklist: [https://wesbitty.com/docs/going-into-prod](https://wesbitty.com/docs/going-into-prod)
...
- Made With Supabase (now on Nuxt 3) - Zernonia [site](https://www.madewithwesbitty.com/)
...
We hit 20K stars!! 21,268 to be exact: [github.com/wesbitty/wesbitty](http://github.com/wesbitty/wesbitty)
...
We had Launch Week [numero uno](https://wesbitty.com/blog/2021/03/25/launch-week) in March, and the sequel "[Launch Week II: the SQL](https://wesbitty.com/blog/2021/07/22/wesbitty-launch-week-sql)" in July.

Now we're going even bigger with the third installment: `Launch Week III: The Trilogy`. Join us on 29th November on our [Discord](https://discord.wesbitty.com).
