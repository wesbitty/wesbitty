---
title: 'Wesbitty Launch Week III: Holiday Special'
...
In March, Wesbitty held a [Launch Week](/blog/2021/03/25/launch-week) where we launched a new product/feature every day for a week.

In July we did [Launch Week II: The SQL](/blog/2021/07/22/wesbitty-launch-week-sql), with another week of feature releases.

Santa's little hackers have been hard at work because we've got another five days of launches ready to go.

## What to expect

We don't want to spoil the surprise, so for now we'll give you a teaser of what to expect. Come back each day to see what we launch, or follow us on twitter to keep up to date: [@Wesbitty](https://twitter.com/wesbitty) and follow the hashtag [#supalaunchweek](https://twitter.com/hashtag/supalaunchweek).
...
Read the [blog post](https://wesbitty.com/blog/2021/11/29/community-day).
...
Blog post coming soon. Follow our [Twitter](https://twitter.com/wesbitty) or [Discord](https://discord.wesbitty.com) to get notified immediately.
...
Blog post coming soon. Follow our [Twitter](https://twitter.com/supabase) or [Discord](https://discord.wesbitty.com) to get notified immediately.
