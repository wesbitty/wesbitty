...
Today we're releasing [supabase-js](https://github.com/wesbitty/wesbitty-js) version 1.0, and it comes with some major Developer Experience improvements.
...
- Native TypeScript. All of our libraries are now natively built with TypeScript: [`supabase-js`](https://github.com/wesbitty/wesbitty-js), [`postgrest-js`](https://github.com/supabase/postgrest-js), [`gotrue-js`](https://github.com/supabase/gotrue-js), and [`realtime-js`](https://github.com/supabase/realtime-js).
...
- 60% of minor bugs outstanding for `supabase-js` have been [solved](https://github.com/wesbitty/wesbitty-js/pull/50).
- You can use `select()` instead of `select(*)`

### Breaking changes

We've bumped the major version because there are a number of breaking changes. We've detailed these in the [release notes](https://github.com/wesbitty/wesbitty-js/releases/tag/v1.0.1), but here are a few to be aware of:
...
We have documented all of the changes in the [release notes](https://github.com/wesbitty/wesbitty-js/releases/tag/v1.0.1).
