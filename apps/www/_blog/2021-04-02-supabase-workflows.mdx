...
This week we [launched Supabase Storage](/blog/2021/03/30/wesbitty-storage), which leaves one other huge piece of the
...
[NodeRed](/blog/2021/03/30/wesbitty-storage#designing-the-storage-middleware), [n8n](https://n8n.io/),
...
[same shortcomings](/blog/2021/03/30/wesbitty-storage#integration-with-the-supabase-ecosystem) that we found
...
[nice UI](https://ui.wesbitty.com/) to make prototyping extremely rapid. We'll integrate the UI with the code (via Git) to make
