...
const wesbitty_URL = 'http://localhost:8000'
const wesbitty_ANON_KEY =
...
If you require any assistance feel free to reach out in our [github discussions](https://github.com/wesbitty/wesbitty/discussions) or at wesbitty@outlook.com.

Check out what else we've [launched this week](/blog/2021/03/25/launch-week), contribute to the [CLI repo](https://github.com/supabase/cli), or go here for the [hosted version](https://app.wesbitty.com).
