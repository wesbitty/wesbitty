---
title: Launch week
description: Five days of Wesbitty.
author: ant_wilson
author_title: Wesbitty
author_url: https://github.com/awalias
author_image_url: https://github.com/awalias.png
authorURL: https://github.com/awalias
image: wesbitty-launch-week.png
thumb: wesbitty-launch-week.png
tags:
  - storage
  - pricing
  - developers
...
If you aren’t confident in our business model though, we’re open source. You can [host it yourself](https://github.com/wesbitty/wesbitty/tree/master/docker). Even better, everything we build is centered around Postgres, so you can pretty much `pgdump` your database and take it to your favorite Postgres platform.
...
Checkout the launch post here: [Supabase Storage](/blog/2021/03/30/wesbitty-storage)
...
Check out the demo and documentation website directly here: [ui.wesbitty.com](https://ui.wesbitty.com/)
...
3. wesbitty.com is now wesbitty.com - check out our origin story here: [/blog/2021/04/02/supabase-dot-com](/blog/2021/04/02/supabase-dot-com)
