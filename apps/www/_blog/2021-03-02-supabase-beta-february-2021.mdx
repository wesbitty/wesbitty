...
- We released a [Docker Compose](https://github.com/wesbitty/wesbitty/blob/master/docker/docker-compose.yml) file for running Supabase locally. This will be used in our upcoming CLI.
...
One of the community, [@ftonato](https://github.com/ftonato), has built an amazing [example](https://github.com/wesbitty/wesbitty/tree/master/examples/with-stencil) that shows how to use Supabase with [Stencil](https://stenciljs.com/) (a Web Component compiler built by they [Ionic](https://ionicframework.com/) team.)

[Check it out!](https://github.com/wesbitty/wesbitty/tree/master/examples/with-stencil)
...
We hit 6000 GitHub stars on [GitHub](https://github.com/wesbitty/wesbitty)
...
![Supabase Storage coming soon](/images/blog/feb/wesbitty-storage.png)
