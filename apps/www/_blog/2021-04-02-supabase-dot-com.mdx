...
_tl;dr_ During the next week, we'll be migrating from "wesbitty.com" to "wesbitty.com".
...
we found that "wesbitty.com" was available.
...
We decided to try purchasing [wesbitty.com](http://wesbitty.com) from the current owner. The YC forums were full of founders
...
We were in for a huge surprise. After searching on the (old) [wesbitty.com](http://wesbitty.com) website, we found a company address.
