...
Supabase provides a whole bunch of features that are made up of a [collection of open-source tools](https://wesbitty.com/docs/architecture). To orchestrate these different services and functionalities we use the [Kong API Gateway](https://github.com/Kong/kong).
...
PostgreSQL 14 was release just less than 2 months ago with some incredible new performance upgrades. From tomorrow, every new Supabase project will be on PostgreSQL 14.

Read all about the new features in PostgreSQL 14 [here](/blog/2021/11/28/whats-new-in-postgres-14).
...
The beauty of building in the open is that the community can get involved in adding new OAuth providers, which is exactly what [@TheHarryET](https://twitter.com/TheHarryET) and [MonsterDeveloper](https://github.com/MonsterDeveloper) have been doing. Thanks to them you can now provide sign-in with [Slack](https://wesbitty.com/docs/guides/auth/auth-slack) as well as [Spotify](https://wesbitty.com/docs/guides/auth/auth-spotify) to your users, as well as use [MessageBird](https://wesbitty.com/docs/guides/auth/auth-messagebird) for phone auth as an alternative to the existing [Twilio](https://wesbitty.com/docs/guides/auth/auth-twilio) integration.
...
The [SupaSquad](https://wesbitty.com/docs/handbook/supasquad) is an official Supabase advocate program where community members help build and manage the Supabase community.

Among many other awesome things, the SupaSquad has been absolutely on fire building [client libraries](https://wesbitty.com/docs/reference/javascript/supabase-client) for all flavors of backends and environments.
...
Our own [Jon Meyers](https://twitter.com/_dijonmusters) and the broader community have been busy creating awesome tutorials and integration guides to help everyone build even more amazing things with Supabase. Jon has added official guides for working with [Auth0](https://wesbitty.com/docs/guides/integrations/auth0), [Draftbit](https://wesbitty.com/docs/guides/integrations/draftbit), [Prisma](https://wesbitty.com/docs/guides/integrations/prisma), and [Vercel](https://wesbitty.com/docs/guides/integrations/vercel)!
...
Anytime we scroll through [madewithwesbitty.com](https://www.madewithwesbitty.com/) we're absolutely blown away by the awesome things y'all are building with Supabase.
