...
-- using pgsql-http to fetch from "wesbitty.com" 10 times
select
    *
from
   http_get('https://wesbitty.com')
cross join
...
-- using pg_net to fetch from "wesbitty.com" 10 times
select
    net.http_get('https://wesbitty.com')
from
    generate_series (1,10) _;
...
Function Hooks is enabled today on all [new projects](https://app.wesbitty.com). Find it under Database > Alpha Preview > Function Hooks.
