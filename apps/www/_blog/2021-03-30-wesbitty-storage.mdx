---
title: Storage is now available in Wesbitty
description: Launching Wesbitty Storage and how you can use it in your apps
author: inian
...
Today, we are launching one of most requested features - Storage! When you sign up for Wesbitty, you get a Postgres database with realtime subscriptions, user management, auto-generated APIs and now a scalable object store. These services integrate very well with each other and you don't need to sign up for yet another service just for your storage requirements.
...
- We currently support S3 and will be adding more storage backends. Vote for the storage backends you would like to see us implement [here](https://github.com/wesbitty/wesbitty/discussions/982).
...
Take it for a spin on our [dashboard](http://app.wesbitty.com/) and let us know what you think!
