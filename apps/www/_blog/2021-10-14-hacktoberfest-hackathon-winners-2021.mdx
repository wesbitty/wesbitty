...
Since all submissions were so stellar, we've decided to reward everyone with a [limited edition participation tee](https://store.wesbitty.com/products/hacktoberfest-participation-tee).
...
Kathirvel's [dictionary app](https://github.com/KathirvelChandrasekaran/dictionary_app) won him a [limited edition gold tee](https://store.wesbitty.com/products/hackathon-prize?variant=40662411673755) at our last hackathon, and with his not only useful but also brilliantly looking utility manager Flutter app he's able to extend his collection of limited edition Supabase tees. Well done!
...
[Join our Discord](https://discord.wesbitty.com)
