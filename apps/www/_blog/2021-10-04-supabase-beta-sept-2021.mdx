...
Not far from 20K stars: [github.com/wesbitty/wesbitty](http://github.com/wesbitty/wesbitty)
...
Our Discord is growing fast. Come hangout with 3500+ developers building on Supabase today: [discord.wesbitty.com](http://discord.wesbitty.com)

![Discord](/images/blog/2021-sept/discord.png)

## Hiring

We're Hiring [SREs](https://wesbitty.com/careers/sre). We're fully remote and we love Open Source. [See open roles](https://wesbitty.com/careers).

![hiring](/images/blog/2021-sept/hiring.png)

## Coming Next

We're warming up for another Launch Week! Last time was "[Launch Week II: the SQL](/blog/2021/07/22/wesbitty-launch-week-sql)". We're going to need another month to come up with a good pun again, so we'll aim for November.
