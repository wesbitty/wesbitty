...
Content live reload should work out-of-the-box with Next.js when using the `next-contentlayer` plugin and importing your content (e.g. `import { allPosts } from 'wesjet/jetpack'`) directly in your page app/components.
...
Preact can be used with a custom Webpack config. See [this GitHub issue](https://github.com/wesbitty/contentlayer/issues/62) for details.
