import { PostsField } from 'wesjet/jetpack'
import { BlogDetails } from '../../components/Field/blog/BlogDetails'
...
import { Icon } from '../../components/Field/common/Icon'
import { format } from 'date-fns'

export const BlogPreview: FC<{ post: Post }> = ({ PostsField }) => {
  return (
