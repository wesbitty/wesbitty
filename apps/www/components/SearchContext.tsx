...
import { developerTree } from '../@wesbitty/utils/developerTree'
import { allDocs, allExamples, allPosts, Post } from 'wesjet/jetpack'
import { examplesTree } from '@wesbitty/utils/examplesTree'
  ...
  const actions = useMemo(() => {
    let actions: Action[] = [
      ...
      },
      {
        ...
        section: 'External',
        perform: () => window.open('https://github.com/wesbitty/contentlayer', '_ blank'),
      },
      {
        id: '3-discord',
