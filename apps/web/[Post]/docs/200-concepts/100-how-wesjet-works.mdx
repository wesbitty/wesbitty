---
title: How Wesjet Works
excerpt: Wesjet is the glue between your content and your code.
---

Wesjet is the glue between your content and your code.
...
Other frameworks like Next.js take no stance on content, and leave it up to you. _That_ is where Wesjet shines.

## Three Facets of Wesjet

There are three main uses for Wesjet, each revolving around the primary purpose of transforming your content into data that can be easily consumed by your code. These pieces are:
...
Regardless of the source of the data or how the data will be used in the code, the primary purpose for Wesjet is to transform content in to data that your code can use.
...
When using local files as your data source, Wesjet provides the ability to define the schema of those files. That way you can be confident in the shape of the data, and can write more solid code reflecting that shape.

## Defining Data Types

Wesjet's _cherry on top_ is for all you TypeScript fans. When Wesjet transforms content into data, it also creates type definitions for that data. That means you can introspect the structure of content in your code. This can provide you with a level of confidence that could really only be matched by writing programmatic tests.
