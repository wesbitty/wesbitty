...
excerpt: Though not required, TypeScript is an important piece of Wesjet. Let us convince you why.
---
...
## Using TypeScript with Wesjet

Using TypeScript is how you can get the most out of Wesjet. Wesjet automatically generates type definitions for the transformed content. No extra work or configuration is required.

Because Wesjet caches transformed content locally as JSON data, you can have confidence that the data being imported into your pages is in the shape you'd expect.
...
```ts
import { allPosts, Post } from 'wesjet/generated'
