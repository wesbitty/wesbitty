...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <Card title="Try it Now" icon="gitpod" url={{url: 'https://github.com/wesbitty/wesjet/blob/ace/examples', label: 'Try in Gitpod'}}>
    If you'd like to dive right in and start playing with Wesjet, you can open the project in Gitpod.

  </Card>
  <Card title="Example Project" icon="github" url={{url: 'https://github.com/wesbitty/wesjet/blob/ace/examples', label: 'See example'}}>
    You can find a working version of this tutorial in [this state](https://github.com/wesbitty/wesjet/blob/ace/examples/) of the example project.
