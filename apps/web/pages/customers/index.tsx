        ...
        <div className="relative z-0 dark:bg-scale-200 bg-scale-200 overflow-hidden">
          <div className="container mx-auto mt-44 px-8 sm:px-4 xl:px-20">
            <div className="mx-auto relative z-10">
              ...
              >
                <h1 className="text-scale-1200 mb-3 text-3xl">
                  Customer stories
                </h1>
                <h2 className="text-scale-1100 text-xl">
                  Discover case studies on how Supabase is being used around the
                  world to quickly create outstanding products and set new
                  industry standards.
                </h2>
              </motion.div>
