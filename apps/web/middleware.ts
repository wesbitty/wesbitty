...
export const config = {
  matcher: [
     ...
     */
    '/((?!api/|_next/|_static/|examples/|brand/|images/|[\\w-]+\\.\\w+).*)',
  ],
}
...
export default async function middleware(req: NextRequest) {
  ...
  if (hostname === 'wesbitty.org' || hostname === 'platforms.vercel.app') {
  ...
  if (hostname === 'localhost:3000' || hostname === 'wesbittyv2.vercel.app') {
