  ...
  return (
    ...
    >
      <div className="dark:bg-dark-800 flex-shrink-0">
        <Image className="h-64 w-full object-cover" src={imgUrl} alt={title} />
      </div>
      <div className="dark:bg-dark-700 flex flex-1 flex-col justify-between bg-white p-8">
        ...
        {type === 'Case Study' && postMeta.name.length > 0 && (
          <div className="mt-6 flex items-center">
            <div className="flex-shrink-0">
              ...
              <Image className="h-10 w-10 rounded-full" src={postMeta.avatarUrl} alt="" />
            </div>
            <div className="ml-3">
