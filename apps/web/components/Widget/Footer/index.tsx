...
import { useTheme } from '../../ColorScheme'
...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container relative mx-auto px-6 pt-4 sm:pt-2 md:pt-4 lg:px-8 lg:pt-4 xl:px-8">
          ...
          <div className="space-y-2 xl:col-span-1">
            <Link href="/">
              <Image
                className="w-40"
                src={
                  AppMode ? `${basePath}${Metadata.DarkLogo}` : `${basePath}${Metadata.LightLogo}`
                }
                alt="Wesbitty Logo"
              />
            </Link>
            <div className="flex space-x-5">
              <Link href={Metadata.Twitter} className="text-gray-300 hover:text-gray-400">
              ...
              <Link href={Metadata.Github} className="text-gray-300 hover:text-gray-400">
              ...
              <Link href={Metadata.Discord} className="text-gray-300 hover:text-gray-400">
              ...
              {FooterLinks.map((item) => {
                return (
                  <div key={`footer_${item.title}`}>
                    <h3 className="dark:text-dark-100 pt-8 text-base text-gray-500">
                      {item.title}
                    </h3>
      ...
      <div className="dark:border-dark mt-12 flex justify-center border-t">
        <p className="dark:text-dark-100 mb-0 self-center py-4 text-base text-gray-500">
          &copy; <span>{currentYear}</span> <Link href={Metadata.Url}>Wesbitty</Link>, Inc.
        </p>
      </div>
    </footer>
  )
