  ...
  if (hidden) {
    ...
    return (
      ...
      >
        <div
          className="
            mx-auto flex items-center justify-center gap-6 p-3 text-sm font-medium lg:container
            lg:px-16 xl:px-20
          "
        >
          ...
          <span className="item-center flex gap-2 pr-8 sm:px-3">
            {announcement.badge && (
              <div className="py-0.25 border-gray-1100 whitespace-nowrap rounded-2xl border bg-[#2E2E2E] px-3 py-1	text-white">
                {announcement.badge}
              </div>
            )}
          </span>
