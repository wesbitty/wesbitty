...
import type { UseThemeProps, ColorSchemeProviderProps } from './types'
...
export const ColorSchemeProvider: React.FC<ColorSchemeProviderProps> = (props) => {
...
const Theme: React.FC<ColorSchemeProviderProps> = ({
  forcedTheme,
...
const ThemeScript = memo(
  ({
    ...
    attrs,
    nonce,
  }: ColorSchemeProviderProps & { attrs: string[]; defaultTheme: string }) => {
