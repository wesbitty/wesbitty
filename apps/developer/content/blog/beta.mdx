...
<div className="my-24 xl:-mx-40">
  <Playground
    githubRepo="wesbitty/next-contentlayer-example"
...
We put our claims to the test and [built a simple benchmark study](https://github.com/wesbitty/contentlayer-benchmarks) that compared a Next.js site with 1,000+ markdown content files to the same site using a DIY content processing method. We then built the same site with Gatsby.
...
- Add support for more content sources (e.g. [Contentful](https://github.com/wesbitty/contentlayer/issues/173), [Notion](https://github.com/wesbitty/contentlayer/issues/174), ...) and even supporting [multiple content sources](https://github.com/wesbitty/contentlayer/issues/84) in a single project
- Providing seamless integrations for more site frameworks (such as [Vite](https://github.com/wesbitty/contentlayer/issues/179), [Remix](https://github.com/wesbitty/contentlayer/issues/169), [Astro](https://github.com/wesbitty/contentlayer/issues/171), ...)
...
- Reporting issues in the [GitHub repository](https://github.com/wesbitty/contentlayer) - Please also consider starring the repo 🌟
...
- All contributors for [reporting and investigating issues](https://github.com/wesbitty/contentlayer/issues)
