...
```bash
npx create-next-app -e https://github.com/wesbitty/next-template
```
...
If you have created a project using `create-next-app`, you can use the `@wesbitty/ui` CLI to initialize the project.
