...
const defaultTheme = {
  ...
  accordion: {
    ...
    animate: Object.assign({}, default___animations.accordion),
  },
  /*
   * Badge
   *
  ...
  tabs: {
    ...
    size: Object.assign({}, default__padding_and_text),
  ...
  checkbox: {
    ...
    label_before: Object.assign({ base: 'text-scale-500' }, defaults.size.text),
    label_after: Object.assign({ base: 'text-scale-500' }, defaults.size.text),
    description: Object.assign({ base: `text-scale-900` }, defaults.size.text),
    group: `space-y-3`,
  },
  /*
     *  Radio
  ...
  form_layout: {
    ...
    label: {
      ...
      size: Object.assign({}, defaults.size.text),
    },
    label_optional: {
      base: 'text-scale-900',
      size: Object.assign({}, defaults.size.text),
