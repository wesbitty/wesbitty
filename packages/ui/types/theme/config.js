...
function generateCssVariables() {
  ...
  function generateColors(colors, index, colorSet) {
    ...
    if (key.includes('Dark')) {
      darkColors = Object.assign(Object.assign({}, darkColors), colors)
    } else {
      rootColors = Object.assign(Object.assign({}, rootColors), colors)
      ...
      if (
        ...
        rootColors.fixed = Object.assign(
          Object.assign(
            {},
            rootColors === null || rootColors === void 0
              ? void 0
              : rootColors.fixed
          ),
          colors
  ...
  theme: {
    variables: {
      DEFAULT: {
        ...
        colors: Object.assign({}, variables.root),
      },
      '.dark': {
        colors: Object.assign({}, variables.dark),
      },
    },
    extend: {
      // dropdown extensions
      ...
      colors: Object.assign(Object.assign({}, colorClasses), {
...
function wrapper(tailwindConfig) {
  ...
  return deepMerge(
    Object.assign(Object.assign({}, tailwindConfig), { purge }),
    wesbitty,
    {
