            ...
            children: [
              _jsxs(
                ...
                Object.assign(
                  ...
                  {
                    children: [
                      _jsx('stop', { offset: '0', stopColor: '#fff' }),
                      _jsx('stop', { offset: '1', stopColor: '#fff' }),
                    ],
                  }
                )
              ),
              _jsxs(
                ...
                Object.assign(
                  ...
                  {
                    children: [
                      _jsx('stop', { offset: '0', stopOpacity: '.3' }),
                      _jsx('stop', { offset: '.071', stopOpacity: '.2' }),
                      _jsx('stop', { offset: '.321', stopOpacity: '.1' }),
                      _jsx('stop', { offset: '.623', stopOpacity: '.05' }),
                      _jsx('stop', { offset: '1', stopOpacity: '0' }),
                    ],
                  }
                )
              ),
