...
import { typography, spacing, zIndex as sharedZIndex } from '../../theme/styles'
...
const Arrow = styled.div<ArrowProps>`
  ...
  ${(props) => css`
    ...
    border-top-color: ${ifPlacementEquals(
      props,
      'top',
      'white',
      'transparent'
    )};
    border-bottom-color: ${ifPlacementEquals(
      props,
      'bottom',
      'white',
      'transparent'
    )};
    border-left-color: ${ifPlacementEquals(
      props,
      'left',
      'white',
      'transparent'
    )};
    border-right-color: ${ifPlacementEquals(
      props,
      'right',
      'white',
      'transparent'
