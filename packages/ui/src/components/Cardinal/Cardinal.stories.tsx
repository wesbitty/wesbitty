...
export const AllCardinals = () => (
  <div style={{ background: 'white' }}>
    <Cardinal isLoading size="small" count={undefined} text={''} />
    ...
    <br />
    <Cardinal isLoading count={undefined} text={''} />
...
export const SmallLoading = () => <Cardinal isLoading size="small" count={undefined} text={''} />;
...
export const LargeLoading = () => <Cardinal isLoading size="large" count={undefined} text={''} />;
