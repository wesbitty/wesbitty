...
interface CheckboxProps
  extends Omit<RadixDropdownTypes.DropdownMenuCheckboxItemProps, 'onChange'> {
...
interface RadioGroupProps
  extends Omit<RadixDropdownTypes.DropdownMenuRadioGroupProps, 'onChange'> {
...
export function Label({ className, ...props }: LabelProps) {
  ...
  return (
    <RadixDropdown.Label className={cn(__styles.label, className)} {...props} />
  )
}
