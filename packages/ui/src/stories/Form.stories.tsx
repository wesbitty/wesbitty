...
import { User } from '../components/Icon/IconImportHandler'
import React from 'react'

export default {
  title: 'Form Layouts/Form',
  component: Form,
}
...
export const CardForm = () => {
  ...
  const Panel = ({
    ...
    <div className="bg-gray-100 dark:bg-transparent border border-gray-400 rounded-md w-3/4 mx-auto my-8 shadow overflow-hidden">
      {header && (
      ...
      >
        {({ isSubmitting }: any) => (
          ...
          >
            ...
            <Section
              header={
                <label className="text-sm text-gray-800 dark:text-white col-span-4">
                  Faster checkout
                </label>
              }
            >
                ...
                <Input
                  ...
                  descriptionText={
                    <span>
                      ...
                      <span className="text-blue-900 dark:text-blue-600 underline cursor-pointer transition hover:text-blue-800">
...
export { default as AuthForm } from '../components/Form/examples/AuthForm'
