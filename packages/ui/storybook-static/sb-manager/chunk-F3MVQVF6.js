...
var React = __toESM(require_react()),
  ...
  useInsertionEffectWithLayoutFallback =
    useInsertionEffect2 || import_react.useLayoutEffect
  ...
  switch (typeof interpolation) {
    ...
    case 'object': {
      ...
      if (interpolation.styles !== void 0) {
        ...
        if (next2 !== void 0)
          for (; next2 !== void 0; )
            (cursor = { name: next2.name, styles: next2.styles, next: cursor }),
              (next2 = next2.next)
        var styles = interpolation.styles + ';'
        return (
          interpolation.map !== void 0 && (styles += interpolation.map), styles
        )
      }
    ...
    return (
      useInsertionEffectAlwaysWithSyncFallback(function () {
        for (var i = 0; i < serializedArr.length; i++)
          var res = insertStyles(cache, serializedArr[i], !1)
      }),
      null
    )
  },
...
;(isBrowser2 = !0),
  ...
  isBrowser2 &&
    !isTestEnv &&
    ((globalContext =
      typeof globalThis < 'u' ? globalThis : isBrowser2 ? window : global),
