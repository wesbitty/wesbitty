...
var { FEATURES, SERVER_CHANNEL_URL } = scope,
  ReactProvider = class extends Provider {
    constructor() {
      ...
      if (
        ...
        FEATURES?.storyStoreV7 && SERVER_CHANNEL_URL)
      ) {
        let serverChannel = createChannel2({ url: SERVER_CHANNEL_URL })
