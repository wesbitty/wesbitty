import { Global, keyframes } from './chunk-F3MVQVF6.js'
import { require_react } from './chunk-3FAXWWKG.js'
import './chunk-FENICTK6.js'
import { __toESM } from './chunk-AS2AMEUR.js'
var import_react = __toESM(require_react(), 1)
var hsResizeObserverDummyAnimation = keyframes`0%{z-index:0}to{z-index:-1}`,
  getScrollAreaStyles = (theme) => ({
    ...
    '.os-content>.os-textarea-cover': { zIndex: -1, pointerEvents: 'none' },
    ...
    '.os-scrollbar-horizontal': { bottom: 0, left: 0, right: 10, height: 10 },
    '.os-scrollbar-vertical': { top: 0, right: 0, bottom: 10, width: 10 },
  ...
  GlobalScrollAreaStyles = () =>
    import_react.default.createElement(Global, { styles: getScrollAreaStyles }),
