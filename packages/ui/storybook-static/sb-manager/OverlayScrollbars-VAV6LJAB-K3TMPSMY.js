  ...
  require_OverlayScrollbars = __commonJS({
    '../../node_modules/overlayscrollbars/js/OverlayScrollbars.js'(
      ...
      ;(function (global, factory) {
        ...
        typeof window < 'u' ? window : exports,
          ...
          var PLUGINNAME = 'OverlayScrollbars',
            ...
            COMPATIBILITY = (function () {
              ...
              return {
                ...
                type: function (obj) {
                  return obj === undefined2 || obj === null
                    ? obj + ''
            ...
            EASING = (function () {
              ...
              return {
                  ...
                  return t == 0
                    ...
                    : (p || (p = d * 0.3),
                      ...
                      -(
                        ...
                        _easingsMath.s(((t * d - s) * (2 * _easingsMath.p)) / p)
                      ) + b)
                },
                ...
                easeInOutBounce: function (x, t, b, c, d) {
                  return t < d / 2
                    ? this.easeInBounce(x, t * 2, 0, c, d) * 0.5 + b
                    : this.easeOutBounce(x, t * 2 - d, 0, c, d) * 0.5 +
                        c * 0.5 +
                        b
                },
              }
                      ...
                      (src = target[name]),
                        ...
                        target !== copy &&
                          ...
                          (isPlainObject(copy) ||
                            ...
                            : copy !== undefined2 && (target[name] = copy))
                return target
              }
                ...
                removeFromQ !== !1 && animObj.q.splice(0, 1),
                  animObj.q[LEXICON.l] > 0
                    ...
                    : ((index = inArray(animObj, _animations)),
                      index > -1 && _animations.splice(index, 1))
              }
                ...
                (FakejQuery[LEXICON.p] = {
                  ...
                  attr: function (attrName, value) {
                    for (var i = 0, el; (el = this[i++]); ) {
                      if (value === undefined2) return el.getAttribute(attrName)
                  ...
                  scrollLeft: function (value) {
                    for (var i = 0, el; (el = this[i++]); ) {
                      if (value === undefined2) return el[_strScrollLeft]
                  ...
                  find: function (selector) {
                    ...
                    return (
                      this.each(function () {
                        var el = this,
                          ch = el.querySelectorAll(selector)
              ...
              var _plugin,
                ...
                _pluginsOptions = (function () {
                  var type = COMPATIBILITY.type,
                    ...
                    updateOnLoadTemplate = [
                      ['img'],
                      [TYPES.s, TYPES.a, TYPES.z],
                    ],
                    inheritedAttrsTemplate = [
                      ['style', 'class'],
                      [TYPES.s, TYPES.a, TYPES.z],
                    ],
                    resizeAllowedValues =
                    ...
                    scrollbarsVisibilityAllowedValues =
                      'v:visible h:hidden a:auto',
                    scrollbarsAutoHideAllowedValues =
                          ...
                          for (var prop in template2)
                            if (
                              ...
                              var isValid = !1,
                                ...
                                templateTypes = COMPATIBILITY.isA(templateValue)
                                  ? templateValue
                                  : [templateValue],
...
` + window2.JSON.stringify(objectCopy, null, 2)
                      ...
                      onResize = function () {
                        if (INSTANCES().length > 0) {
                          ...
                          var deltaWRatio = MATH.round(
                            ...
                            dprChanged = newDPR !== windowDpr && windowDpr > 0,
                            isZoom = deltaIsBigger && difference && dprChanged,
              ...
              function OverlayScrollbarsInstance(
                ...
                var _nativeScrollbarIsOverlaid,
                  ...
                  _classNameHostOverflow = _classNameHostElement + '-overflow',
                  _classNameHostOverflowX = _classNameHostOverflow + '-x',
                ...
                function setupResponsiveEventListener(
                  ...
                  var collected =
                    ...
                    events = collected ? !1 : eventNames.split(_strSpace),
                    i = 0,
                  ...
                  if (targetElement) {
                    ...
                    if (onElementResizedCallback) {
                      ...
                      var element = targetElement.contents()[0],
                        resizeObserverObj = element[_strResizeObserverProperty]
                      resizeObserverObj &&
                  ...
                  var currClasses =
                    ...
                    oldClasses =
                      typeof oldClassNames == TYPES.s
                        ...
                        : [],
                    diff = getArrayDifferences(oldClasses, currClasses),
                ...
                function update(updateHints) {
                  ...
                  if (
                    ...
                    var checkCacheAutoForce = function () {
                      ...
                      paddingAbsolute = _currentPreparedOptions.paddingAbsolute,
                    ...
                    var textareaSize = _isTextarea ? textareaUpdate() : !1,
                      textareaSizeChanged =
                        _isTextarea &&
                    ...
                    if (
                        ...
                        var textareaCoverCSS = {},
                          setContentGlueElementCSSfunction = function (
                            ...
                            var scrollbarVars = getScrollbarVars(horizontal),
                              ...
                              paddingSize = horizontal ? _paddingX : _paddingY,
                      ...
                      if (
                        ...
                        if (_isRTL && widthAuto) {
                          ...
                          posLeftWithoutFloat !== posLeftWithFloat &&
                      ...
                      if (
                        ...
                        if (textareaInfo) {
                          var textareaRowsChanged =
                            ...
                            cursorPos = textareaInfo._cursorPosition,
                            cursorMax = textareaInfo._cursorMax,
                      ...
                      var scrollbarsVisibilityVisible =
                        ...
                        scrollbarsVisibilityAuto = scrollbarsVisibility === 'a',
                ...
                function setupStructureEvents() {
                  ...
                  function contentOnTransitionEnd(event) {
                    _autoUpdateCache !== !0 &&
                      ((event = event.originalEvent || event),
                      isSizeAffectingCSSProperty(event.propertyName) &&
                        _base.update(_strAuto))
                  }
                ...
                function setupScrollbarsDOM(destroy) {
                  var selectOrGenerateScrollbarDOM = function (isHorizontal) {
                    var scrollbarClassName = isHorizontal
                        ? _classNameScrollbarHorizontal
                        : _classNameScrollbarVertical,
                      scrollbar = selectOrGenerateDivByClass(
                ...
                function setupScrollbarEvents(isHorizontal) {
                  ...
                  function onMouseTouchDownContinue(event) {
                    var originalEvent = event.originalEvent || event,
                      isTouchEvent = originalEvent.touches !== undefined2
                    return _sleeping ||
                      _destroyed ||
                      nativeOverlayScrollbarsAreActive() ||
                      !_scrollbarsDragScrollingCache ||
                    ...
                    if (onMouseTouchDownContinue(event)) {
                      var trackLength = scrollbarVarsInfo._trackLength,
                        ...
                        scrollRaw =
                          ...
                          mouseDownInvertedScale,
                        scrollDeltaPercent =
                          scrollRaw / (trackLength - handleLength),
                  ...
                  function documentMouseTouchUp(event) {
                    if (
                      ...
                      mouseInsideHost || hostOnMouseLeave(),
                        (_scrollbarsAutoHideScroll ||
                          _scrollbarsAutoHideMove) &&
                          refreshScrollbarsAutoHide(!1)
                    }
                ...
                function refreshScrollbarsAutoHide(shallBeVisible, delayfree) {
                  if (
                    ...
                    _scrollbarsAutoHideDelay > 0 && delayfree !== !0
                ...
                function refreshScrollbarHandleLength(isHorizontal) {
                  ...
                  ;(handleCSS[scrollbarVars._width_height] =
                    MATH.floor(handleRatio * 100 * digit) / digit + '%'),
                    nativeOverlayScrollbarsAreActive() ||
                ...
                function refreshScrollbarHandleOffset(
                  ...
                  var transition = type(scrollOrTransition) == TYPES.b,
                    ...
                    unsnappedScrollRatio = getScrollRatio(currentScroll),
                    handleOffset = getHandleOffset(unsnappedScrollRatio),
...
`),
                      ...
                      textareaCurrentCursorRowSplit = textareaValue.substr(
                        0,
...
`),
                ...
                function getObjectPropVal(obj, path) {
                  for (
                    var splits = path.split(_strDot), i = 0, val;
                    i < splits.length;
                    i++
                  ) {
                  ...
                  (_base.scroll = function (
                    ...
                    if (arguments.length === 0 || coordinates === undefined2) {
                      ...
                      return (
                        ...
                        {
                          position: { x: scrollX, y: infoY._currentScroll },
                          ratio: {
                            x: scrollXRatio,
                    ...
                    var normalizeRTL = _normalizeRTLCache,
                      ...
                      possibleElementIsJQuery =
                        possibleElement instanceof FRAMEWORK || JQUERY
                          ...
                          : !1,
                      possibleElementIsHTMLElement = possibleElementIsJQuery
                        ? !1
                    ...
                    function getRawScroll(isX, coordinates2) {
                      ...
                      if (
                        ((coordinates2 =
                          type(coordinates2) == TYPES.s ||
                          type(coordinates2) == TYPES.n
                      ...
                      if (
                        (isString
                          ? (rawScroll[strLength] > 2 &&
                              ...
                              inArray(possibleOperator, coordinatesOperators) >
                                -1 && (operator = possibleOperator)),
                            (rawScroll = operator
                              ? rawScroll.substr(2)
                              : rawScroll),
                            (rawScroll = rawScroll[strReplace](/min/g, 0)
                              [strReplace](/</g, 0)
                              [strReplace](
                                /max/g,
                        ...
                        var normalizeIsRTLisX = normalizeRTL && isRTLisX,
                          operatorCurrScroll =
                            ...
                            (normalizeIsRTLisX && _rtlScrollBehavior.n
                              ? -1
                              : 1),
                          invert = normalizeIsRTLisX && _rtlScrollBehavior.i,
                    ...
                    function getPerAxisValue(
                      ...
                      if (valueType == valueInternalType) value = [value, value]
                        ...
                        if (
                          ...
                          valueArrLength > 2 || valueArrLength < 1)
                        )
                          value = resultDefault
                        else
                          for (
                    ...
                    if (
                      ...
                      var margin = coordinatesIsElementObj
                          ? coordinates.margin
                          : 0,
                        axis = coordinatesIsElementObj ? coordinates.axis : 0,
                        scroll = coordinatesIsElementObj
                          ? coordinates.scroll
                          : 0,
                        block = coordinatesIsElementObj ? coordinates.block : 0,
                          ...
                          var measuringElm = finalElement[0],
                            ...
                            finalizeBlock = function (isX) {
                              var vars = getScrollbarVars(isX),
                                ...
                                blockIsCenter = settingsBlock[xy] == strCenter,
                                blockIsNearest =
                                  settingsBlock[xy] == strNearest,
                                scrollNever = settingsScroll[xy] == strNever,
                                scrollIfNeeded =
                                ...
                                viewportCenterOffset = vpOffset + vpSize / 2,
                                isInView =
                                  elSize <= vpSize &&
                                  elOffset >= vpOffset &&
                ...
                function construct(targetElement, options2, extensions2) {
                  ...
                  return _nativeScrollbarIsOverlaid.x &&
                    _nativeScrollbarIsOverlaid.y &&
                    ...
                    : (_isBody &&
                      ...
                      COMPATIBILITY.isA(extensions2)
                        ...
                        : FRAMEWORK.isPlainObject(extensions2) &&
  ...
  OverlayScrollbarsComponent = ({
    ...
    let osTargetRef = (0, import_react.useRef)(),
      osInstance = (0, import_react.useRef)()
    return (
...
function mergeHostClassNames(osInstance, className) {
  if (import_overlayscrollbars.default.valid(osInstance)) {
    let { host } = osInstance.getElements(),
      regex = new RegExp(
