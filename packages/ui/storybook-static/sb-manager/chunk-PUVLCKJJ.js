...
Check the render method of \`` +
      ...
      var createMicrosoftUnsafeLocalFunction = function (func) {
        ...
        setInnerHTML = createMicrosoftUnsafeLocalFunction(function (
          node,
          html
        ) {
...
Incoming: %s`,
      ...
      function updateHostComponent(
        ...
        pushHostContext(workInProgress2),
          current2 === null && tryToClaimNextHydratableInstance(workInProgress2)
        var type = workInProgress2.type,
...
For more info, visit https://fb.me/react-mock-scheduler`))
      ...
      function startWorkOnPendingInteractions(root2, expirationTime) {
        ...
        if (
          (root2.pendingInteractionMap.forEach(function (
      ...
      instance = {
        ...
        setOptions: function (setOptionsAction) {
          ...
          if (
            ...
            getBasePlacement(state.options.placement) === auto)
          ) {
