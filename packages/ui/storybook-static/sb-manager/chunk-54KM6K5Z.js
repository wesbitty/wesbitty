...
function highlight_default(defaultAstGenerator, defaultStyle) {
  return function (_ref7) {
    ...
    var defaultCodeValue = [{ type: 'text', value: code }],
      codeTree = getCodeTree({ astGenerator, language, code, defaultCodeValue })
...
var prism_light_default = SyntaxHighlighter,
  Container = emotion_styled_browser_esm_default.div(({ theme }) => ({
    position: 'absolute',
    bottom: 0,
    right: 0,
    maxWidth: '100%',
  ...
  ActionButton = emotion_styled_browser_esm_default.button(
    ({ theme }) => ({
      margin: 0,
      border: '0 none',
      padding: '4px 10px',
...
var ActionBar = ({ actionItems, ...props }) =>
  ...
  GlobalScrollAreaStyles = (0, import_react.lazy)(() =>
    import('./GlobalScrollAreaStyles-XIHNDKUY-F4JIPIHL.js')
  ),
  OverlayScrollbars = (0, import_react.lazy)(() =>
    import('./OverlayScrollbars-VAV6LJAB-K3TMPSMY.js')
  ),
  Scroller = ({ horizontal, vertical, ...props }) =>
    import_react.default.createElement(
      import_react.Suspense,
      { fallback: import_react.default.createElement('div', { ...props }) },
      import_react.default.createElement(GlobalScrollAreaStyles, null),
      import_react.default.createElement(OverlayScrollbars, {
...
var Wrapper = emotion_styled_browser_esm_default.div(
  ...
  Code = emotion_styled_browser_esm_default.div(({ theme }) => ({
    flex: 1,
    paddingLeft: 2,
