try {
  ...
  var be = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports)
  var Ae = (t, e, r, o) => {
  ...
  c()
  i()
  var Ze = __STORYBOOKADDONS__,
    { addons: I, types: $, mockChannel: et } = __STORYBOOKADDONS__
  a()
  c()
  i()
  var at = __STORYBOOKTHEMING__,
    {
      CacheProvider: ct,
      ClassNames: it,
      Global: lt,
  ...
  c()
  i()
  var sr = __STORYBOOKCOMPONENTS__,
    {
      A: fr,
      ActionBar: mr,
      AddonPanel: pr,
  ...
  c()
  i()
  var Ao = __STORYBOOKCOREEVENTS__,
    {
      CHANNEL_CREATED: Po,
      CONFIG_ERROR: Co,
      CURRENT_STORY_WAS_SET: Do,
      DOCS_PREPARED: ko,
      DOCS_RENDERED: H,
      FORCE_REMOUNT: wo,
      FORCE_RE_RENDER: No,
      ...
      NAVIGATE_URL: Lo,
      PLAY_FUNCTION_THREW_EXCEPTION: xo,
      PRELOAD_ENTRIES: jo,
      PREVIEW_BUILDER_PROGRESS: Yo,
      PREVIEW_KEYDOWN: Bo,
      REGISTER_SUBSCRIPTION: Ho,
      RESET_STORY_ARGS: Go,
      SELECT_STORY: Ko,
      SET_CONFIG: Uo,
      SET_CURRENT_STORY: Wo,
      SET_GLOBALS: zo,
      SET_INDEX: Fo,
      SET_STORIES: G,
      SHARED_STATE_CHANGED: Vo,
      SHARED_STATE_SET: Xo,
      STORIES_COLLAPSE_ALL: qo,
      STORIES_EXPAND_ALL: $o,
      STORY_ARGS_UPDATED: Jo,
      STORY_CHANGED: K,
      STORY_ERRORED: Qo,
      ...
      STORY_SPECIFIED: nn,
      STORY_THREW_EXCEPTION: an,
      STORY_UNCHANGED: cn,
      UPDATE_GLOBALS: ln,
      UPDATE_QUERY_PARAMS: un,
      UPDATE_STORY_ARGS: sn,
  ...
  var En = __STORYBOOKAPI__,
    {
      ...
      controlOrMetaKey: Tn,
      controlOrMetaSymbol: hn,
      eventMatchesShortcut: gn,
      eventToShortcut: bn,
      isMacLike: An,
      isShortcutTaken: Pn,
      keyToSymbol: Cn,
    ...
    if (r != null) {
      ...
      try {
        if (((l = (r = r.call(t)).next), e === 0)) {
          ...
          for (
            ;
            !(O = (o = l.call(r)).done) && (S.push(o.value), S.length !== e);
            O = !0
          );
      } catch (f) {
        ;(R = !0), (n = f)
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  var fe = 'sb-addon-themes-3',
    b =
      (W = Y.matchMedia) === null || W === void 0
        ? void 0
        : W.call(Y, '(prefers-color-scheme: dark)'),
    V = {
      classTarget: 'body',
      dark: A.dark,
      darkClass: ['dark'],
    ...
    C = function (e) {
      Y.localStorage.setItem(fe, JSON.stringify(e))
    },
    me = function (e, r) {
      var o = r.current,
        n = r.darkClass,
        ...
        s = r.lightClass,
        S = s === void 0 ? V.lightClass : s
      if (o === 'dark') {
        var O, R
        ;(O = e.classList).remove.apply(O, x(j(S))),
          (R = e.classList).add.apply(R, x(j(l)))
      } else {
        var f, g
        ;(f = e.classList).remove.apply(f, x(j(l))),
          (g = e.classList).add.apply(g, x(j(S)))
      }
    },
    j = function (e) {
      var r = []
    ...
    v = function () {
      var e =
        ...
        r = Y.localStorage.getItem(fe)
      if (typeof r == 'string') {
        var o = JSON.parse(r)
        return (
          e &&
            (e.dark &&
              !(0, F.default)(o.dark, e.dark) &&
              ((o.dark = e.dark), C(o)),
            e.light &&
              !(0, F.default)(o.light, e.light) &&
              ((o.light = e.light), C(o))),
          o
        )
      }
  ...
  function Ke(t) {
    var e = t.api,
      ...
      g = J(
        function () {
          return v(R).userHasExplicitlySetTheTheme
        },
        [R]
      ),
      w = M(
      ...
      h = M(
        function (m) {
          var y = v(),
            N = m || (y.current === 'dark' ? 'light' : 'dark')
          C(_(_({}, y), {}, { current: N })), w(N)
        },
        [w]
      )
    function X(m) {
      g || S || h(m.matches ? 'dark' : 'light')
    }
    var T = M(
        function () {
          var m = v(),
      ...
      _e = function () {
        h()
        var y = v()
        C(_(_({}, y), {}, { userHasExplicitlySetTheTheme: !0 }))
      }
    return (
      P(
        function () {
          var m = v()
          C(_(_(_({}, m), s), {}, { current: m.current || s.current })), T()
        },
        [s, T]
      ),
      P(function () {
        return (
          ...
          b.addListener(X),
          function () {
            f.removeListener(K, T),
              f.removeListener(G, T),
              f.removeListener(H, T),
              b.removeListener(X)
          }
        )
      }),
  ...
  function Se(t) {
    for (var e = 1; e < arguments.length; e++) {
      var r = arguments[e] != null ? arguments[e] : {}
      e % 2
        ? Ee(Object(r), !0).forEach(function (o) {
            Ue(t, o, r[o])
          })
        : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(r))
        : Ee(Object(r)).forEach(function (o) {
            Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(r, o))
          })
    }
    return t
  ...
  var Oe = v(),
    ye = Oe.current || (b.matches && 'dark') || 'light'
  I.setConfig({ theme: Se(Se({}, A[ye]), Oe[ye]) })
