try {
  ...
  var st = Object.create,
    ...
    le = (e, t) =>
      function () {
        return (
          t || (0, e[ke(e)[0]])((t = { exports: {} }).exports, t), t.exports
        )
      },
    ft = (e, t) => {
  ...
  var Lt = ({ rows: e, columns: t, rowsData: r }) => {
    ...
    He = ({
      ...
      return a.createElement(
        ...
        t &&
          a.createElement(It, null, a.createElement(Dt, { sortAscending: e }))
      )
    },
    Mt = ({
    ...
    kt = (e) =>
      a.createElement(We, { nodeRenderer: Ht, dataIterator: Ut, ...e }),
    Gt = ue(kt),
    Vt = dt(gt()),
