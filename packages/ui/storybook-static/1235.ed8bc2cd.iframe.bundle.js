/*! For license information please see 1235.ed8bc2cd.iframe.bundle.js.LICENSE.txt */
        ...
        function () {
          ...
          var _ = (function runInContext(context) {
            ...
            function getHolder(func) {
              return (
                hasOwnProperty.call(lodash, 'placeholder') ? lodash : func
              ).placeholder
            }
            ...
            function iteratee(func) {
              return baseIteratee(
                'function' == typeof func ? func : baseClone(func, 1)
              )
            }
            ...
            return (
              ...
              (lodash.split = function split(string, separator, limit) {
                return (
                  ...
                  (limit = limit === undefined ? 4294967295 : limit >>> 0)
                    ? (string = toString(string)) &&
              ...
              (lodash.isWeakSet = function isWeakSet(value) {
                return (
                  isObjectLike(value) && '[object WeakSet]' == baseGetTag(value)
                )
              }),
