...
function Toggle(_a) {
  ...
  var {
    ...
    props = _tslib.__rest(_a, ["disabled", "id", "name", "layout", "error", "descriptionText", "label", "afterLabel", "beforeLabel", "labelOptional", "onChange", "onBlur", "onFocus", "onKeyDown", "defaultChecked", "checked", "className", "align", "size", "validation", "labelLayout"]);
  const __styles = handler["default"]('toggle');
  const {
    formContextOnChange,
    values,
    errors,
  ...
  const [intChecked, setIntChecked] = React.useState((_b = defaultChecked || checked) !== null && _b !== void 0 ? _b : false);
