...
declare function ContextMenu({ onOpenChange, alignOffset, overlay, children, className, style, }: RootProps): import("react/jsx-runtime").JSX.Element;
...
export declare function Item({ children, icon, disabled, onClick }: ItemProps): import("react/jsx-runtime").JSX.Element;
