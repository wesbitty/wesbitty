...
function Listbox(_ref) {
  ...
  return jsx(FormLayout, Object.assign({
    ...
    children: jsxs(RadixDropdown.Root, {
      children: [jsx(RadixDropdown.Trigger, Object.assign({
        asChild: true,
        disabled: disabled
      }, {
        children: jsxs("button", Object.assign({
          ...
          children: [jsxs("span", Object.assign({
            ...
            children: [icon && jsx(InputIconContainer, {
              icon: icon
            }), (selectedNode === null || selectedNode === void 0 ? void 0 : selectedNode.addOnBefore) && jsx(selectedNode.addOnBefore, {}), jsx("span", Object.assign({
      ...
      })), jsx(RadixDropdown.Content, Object.assign({
        sideOffset: 6,
        loop: true,
        side: 'bottom',
        align: "center",
        ...
        children: jsx("div", {
          children: jsx(SelectContext.Provider, Object.assign({
            value: {
...
function SelectOption(_ref2) {
  ...
  const __styles = styleHandler('listbox');
  return jsx(SelectContext.Consumer, {
    children: _ref3 => {
      let {
        onChange,
        selected
