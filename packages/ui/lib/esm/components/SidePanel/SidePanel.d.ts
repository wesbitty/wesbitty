...
declare const SidePanel: {
    ({ id, className, children, header, visible, open, size, loading, align, hideFooter, customFooter, onConfirm, onCancel, confirmText, cancelText, triggerElement, defaultOpen, ...props }: SidePanelProps): import("react/jsx-runtime").JSX.Element;
