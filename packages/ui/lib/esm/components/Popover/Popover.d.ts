...
declare function Popover({ align, ariaLabel, arrow, children, className, defaultOpen, modal, onOpenChange, open, overlay, portalled, side, sideOffset, style, header, footer, size, }: RootProps): import("react/jsx-runtime").JSX.Element;
